 ...
 *    options.pick {string|array} - 'lines' or 'lines.covered' or array of such
 *    options.depth {number} -
 *    options.ignoreAdded {boolean}
 *    options.ignoreRemoved {boolean}
 *    options.ignoreLinesCovered {boolean}
 *
 ...
 * @param depth {number}
 * @param options {object}
 *    options.rootDepth - the depth of the root node
 * @returns {object}
 */
